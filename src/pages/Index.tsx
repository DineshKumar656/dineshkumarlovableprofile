            ...
            <div className={`relative transform transition-all duration-1000 delay-300 ${
              ...
              <div className="relative">
                ...
                <div className="w-80 h-80 mx-auto bg-gradient-to-br from-white/30 to-white/10 rounded-full border-2 border-white/40 backdrop-blur-sm flex items-center justify-center relative overflow-hidden group">
                  ...
                  <div className="absolute inset-1 rounded-full bg-gradient-to-br from-orange-400/20 to-red-400/20 backdrop-blur-sm"></div>
                </div>
                ...
                {/* Floating tech icons */}
                <div className="absolute top-16 left-8 text-white/60 animate-bounce" style={{animationDelay: '0.5s'}}>
                  <Code className="h-6 w-6" />
                </div>
                <div className="absolute top-32 right-12 text-white/60 animate-bounce" style={{animationDelay: '1s'}}>
